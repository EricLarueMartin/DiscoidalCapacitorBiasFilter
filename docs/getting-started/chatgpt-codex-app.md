...
Return to the top of the DiscoidalCapacitorBiasFilter GitHub repository page, above the README, and select **Code**.
...
In the desktop app, open the `DiscoidalCapacitorBiasFilter` folder as the working folder and start a Codex task. Send this prompt:
