...
Return to the top of the DiscoidalCapacitorBiasFilter GitHub repository page and select **Code**. Either choose **Download ZIP** and extract it, or copy the HTTPS address and clone the repository:

```text
git clone https://github.com/EricLarueMartin/DiscoidalCapacitorBiasFilter.git
```

Open the resulting `DiscoidalCapacitorBiasFilter` folder as the agent's project or workspace. Then send:
